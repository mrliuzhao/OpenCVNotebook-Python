import cv2
import numpy as np
from CarDetection.detector import train_bowextractor, bow_features
from CarDetection.detector import train_bownn
...
if vocabulary is None:
    vocabulary, bow_extractor = train_bowextractor(cluster_count, sift, flann_mat)
    np.save(r".\resources\carSIFT50.npy", vocabulary)
else:
    bow_extractor = cv2.BOWImgDescriptorExtractor(sift, flann_mat)
    bow_extractor.setVocabulary(vocabulary)

# 以BOW作为输入训练二分类神经网络
train_bownn(bow_extractor, sift)
