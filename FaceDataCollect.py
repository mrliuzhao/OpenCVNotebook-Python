...
lowerBody_xml = cv2.CascadeClassifier(r'C:\Program Files\Python37\Lib\site-packages\cv2\data\haarcascade_lowerbody.xml')
upperBody_xml = cv2.CascadeClassifier(r'C:\Program Files\Python37\Lib\site-packages\cv2\data\haarcascade_upperbody.xml')
...
while True:
    ...
    lbs = lowerBody_xml.detectMultiScale(gray, 1.3, 5)
    ubs = upperBody_xml.detectMultiScale(gray, 1.3, 5)
